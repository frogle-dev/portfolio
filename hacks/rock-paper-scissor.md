...
<script type="module">
  ...
  const instructionsHTML = `
    ...
    <div id="quickCommands" style="display:flex; justify-content:center; gap:10px; margin-top:20px;">
      <button id="btnRockRadius" style="padding:8px 12px; cursor:pointer;">Rock Radius</button>
      <button id="btnPaperOpacity" style="padding:8px 12px; cursor:pointer;">Paper Opacity</button>
      <button id="btnScissorsShadow" style="padding:8px 12px; cursor:pointer;">Scissors Shadow</button>
  ...
  class GameObject {
    ...
    setOpacity(value) {
      this.el.style.opacity = value;  // value between 0 (invisible) and 1 (fully visible)
      return this;
    }
  ...
  document.getElementById("scissors-btn").addEventListener("click", () => {
    ...
    // New listeners for buttons that actually run the commands
  document.getElementById("btnRockRadius").addEventListener("click", () => {
    rock.setRadius(50);
    alert("🪨 Extra console command #1:\n\nrock.setRadius(50);");
  });
  document.getElementById("btnPaperOpacity").addEventListener("click", () => {
    paper.setOpacity(0.67);
    alert("📄 Extra console command #2: \n\npaper.setOpacity(0.67);")
  });
  document.getElementById("btnScissorsShadow").addEventListener("click", () => {
    scissors.setShadow('4px 6px 10px rgba(0,0,0,0.5)');
    alert("✂️ Extra console command #3: \n\nscissors.setShadow('4px 6px 10px rgba(0,0,0,0.5)');")
  });
